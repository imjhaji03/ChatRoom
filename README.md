...
##⚡ Async Pattern
    async_read_until() with delimiter (e.g. newline)
    
    async_write() using output buffers
    
    Handlers use shared_from_this() for lifetime management
    
    io_context.post() ensures safe writes across threads
